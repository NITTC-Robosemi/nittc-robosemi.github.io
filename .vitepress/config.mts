...
export default defineConfig({
  ...
  head: [
    ...
    [
      ...
      {
        property: "og:image",
        content: "https://nittc-robosemi.github.io/assets/TJUJ9115.webp",
      },
    ],
  ...
  async transformHead(context) {
    return [
      ...
      [
        "meta",
        { property: "og:description", content: context.pageData.description },
      ],
    ];
  },
  cleanUrls: true,
  ...
  srcExclude: ["how-to-add-entry.md"],
  sitemap: {
